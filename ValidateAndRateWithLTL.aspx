<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidateAndRateWithLTL.aspx.cs" Inherits="ValidateAndRateWithLTL" MaintainScrollPositionOnPostback="true" %>
                	...
                	<tr>
                		<td>
			                <table cellpadding="5" cellspacing="0" border="0" class="internalTable" width="100%">
								<tr>
			                		<td colspan="2" align="right"><asp:Literal ID="litUsername" runat="server" />  <asp:Literal ID="litPlant" runat="server" /> <a href="Help.aspx#request" class="links">? Help</a></td>
			                	</tr>
			                	<tr>
			                    ...
			                    <tr>
			                        ...
			                        <td class="label" valign="top">
                                        Include Ground Freight Rate?<br />
                                    </td>
			                        <td>
			                    ...
			                    <tr>
			                        ...
			                        <td>
                                        ...
                                        <asp:Panel ID="pnlFreightClass" runat="server" Visible="false">
                                            <table>
                                                <tr>
                                                    <td width="170">Freight Class</td>
                                                    <td>
					...
					<tr>
						<td>
			                ...
			                <center>
			                    ...
			                    <asp:Button ID="btnPlantALP" runat="server" Text="Alpharetta (ALP)" CommandArgument="ALP" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
			                    &nbsp;
			                    <asp:Button ID="btnPlantBUT" runat="server" Text="Butler (BUT)" CommandArgument="BUT" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
			                    &nbsp;
			                    <asp:Button ID="btnPlantFTW" runat="server" Text="Fort Wayne (FTW)" CommandArgument="FTW" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
			                    &nbsp;
			                    <%-- <asp:Button ID="btnPlantPDT" runat="server" Text="Piedmont" CommandArgument="PDT" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
			                    <br /><br />--%>
			                    <asp:Button ID="btnPlantPOR" runat="server" Text="Portland (POR)" CommandArgument="POR" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
                                <br /><br />
			                    <asp:Button ID="btnPlantBMK" runat="server" Text="Brandmark (BMK)" CommandArgument="BMK" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
                                &nbsp;
			                    <asp:Button ID="btnPlantCOR" runat="server" Text="Corporate (COR)" CommandArgument="COR" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
                                &nbsp;
			                    <asp:Button ID="btnPlantCIN" runat="server" Text="Cincinnati (CIN)" CommandArgument="CIN" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
                                &nbsp;
			                    <asp:Button ID="btnPlantEBT" runat="server" Text="East Butler (EBT)" CommandArgument="EBT" Width="140" OnCommand="btnSelectPlant_Click" class="btn" />
			                </center>
						</td>
					</tr>
				</table>
						...
						<tr>
                            <td colspan="2" valign="top">
                                <table cellpadding="2" cellspacing="0" border="0">
                                    ...
                                    <asp:PlaceHolder ID="phFreightClassDetailSummary" runat="server" Visible="true">
                                        <tr>
                                            <td><br /></td>
                                        </tr>
                                        <tr>
...
We are having some system issues today so you may have some interruptions when retrieving rates. If you need any rates please feel free to call our customer service team at 866-551-1635<br/>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Panel ID="pnlGFRates" runat="server" Visible="true">
                                <br /><br />
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        <td>
                            ...
                            <asp:Panel ID="pnlLTLRates" runat="server" Visible="true">
                                <br /><br />
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        <td>
    ...
    <asp:Label ID="lblResults" runat="server" Visible="true" />
    <asp:Label ID="lblResultsGF" runat="server" Visible="false" /><br />
                    <div style="color:lightgray; text-align:right" > Username: <asp:Label ID="lblUserName" runat="server" /> </div>
