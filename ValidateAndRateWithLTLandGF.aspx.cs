...
public partial class ValidateAndRateWithLTLandGF : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((!Page.IsPostBack) || (Session["DefaultPlant"] == null))
        {
            ...
            //txtGFPickupDate.Text = DateTime.Now.Month.ToString() + "/" + DateTime.Now.Day.ToString() + "/" + DateTime.Now.Year.ToString().Substring(2);
    ...
    private void ShowGFRates(string shipToConsignee, string shipToStreet, string shipToCity, string shipToState, string shipToZip, string shipToCountry, string plantShortCode, bool addressCorrected, int shipWeight, int numPackages)
    {
        ...
        try
        {
            #region -- Define Per Package Charge and Per Shipment Charge dictionaries for GF (charge per plant) --
            ...
            */
            ...
            try
            {
                DateTime datePickup = DateTime.Parse(txtPickupDate.Text);// txtGFPickupDate.Text);
                pickupDate = datePickup.ToString("yyyyMMdd");
            }
            catch (Exception e)
            {
                pickupDate = DateTime.Now.ToString("yyyyMMdd");
            }
            string GFClass = lstLTLClass.SelectedValue.ToString();// lstGFClass.SelectedValue.ToString();

            #region -- Define tblGFServices to hold rate data --

            DataSet dsGFServices = new DataSet();
            DataTable tblGFServices = dsGFServices.Tables.Add();

            tblGFServices.Columns.Add("Plant", typeof(string));
            tblGFServices.Columns.Add("Service", typeof(string));
            tblGFServices.Columns.Add("Rate", typeof(double));
            tblGFServices.Columns.Add("TransitDays", typeof(int));
            tblGFServices.Columns.Add("Direct", typeof(string));
            ...
            foreach (string plantCode in plantCodes)
            {
                ...
                try
                {
                    ...
                    FreightRateWebReference.RequestType request = new FreightRateWebReference.RequestType();
                    String[] requestOption = { "1" }; // 1 = Ground
                    request.RequestOption = requestOption;
                    freightRateRequest.Request = request;

                    /** ****************ShipFrom******************************* */
                    FreightRateWebReference.ShipFromType shipFrom = new FreightRateWebReference.ShipFromType();
                    FreightRateWebReference.AddressType shipFromAddress = new FreightRateWebReference.AddressType();
                    String[] shipFromAddressLines = { "" };
                    shipFromAddress.AddressLine = shipFromAddressLines;
                    shipFromAddress.City = shipFromCity;
                    shipFromAddress.StateProvinceCode = shipFromState;
                    shipFromAddress.PostalCode = shipFromZip;
                    shipFromAddress.CountryCode = shipFromCountry;
                    ...
                    /** ****************ShipTo*************************************** */
                    FreightRateWebReference.ShipToType shipTo = new FreightRateWebReference.ShipToType();
                    FreightRateWebReference.AddressType shipToAddress = new FreightRateWebReference.AddressType();
                    ...
                    FreightRateWebReference.AddressType payerAddress = new FreightRateWebReference.AddressType();
                    ...
                    /** **************Commodity************************************* */
                    FreightRateWebReference.CommodityType commodity = new FreightRateWebReference.CommodityType();
                    ...
                    commodity.NumberOfPieces = numPackages.ToString();
                    
                    RateCodeDescriptionType packagingType = new RateCodeDescriptionType();
                    packagingType.Code = lstGFPackagingType.SelectedItem.Value;
                    packagingType.Description = lstGFPackagingType.SelectedItem.Text.ToUpper();
                    ...
                    weight.Value = shipWeight.ToString();
                    commodity.Weight = weight;

                    //CommodityValueType commodityValue = new CommodityValueType();
                    //commodityValue.CurrencyCode = "USD";
                    //commodityValue.MonetaryValue = "5670";
                    //commodity.CommodityValue = commodityValue;
                    commodity.Description = txtGFCommodityDesc.Text.Trim();
                    commodity.FreightClass = lstLTLClass.SelectedValue.ToString(); //lstGFClass.SelectedValue.ToString();
                    FreightRateWebReference.CommodityType[] commodityArray = { commodity };
                    ...
                    rateCodeDescType.Code = lstGFHandlingUnit.SelectedItem.Value;
                    rateCodeDescType.Description = lstGFHandlingUnit.SelectedItem.Text.ToUpper();
                    ...
                    */
                    ...
                    handUnitType.Quantity = "1";
                    RateCodeDescriptionType rateCodeDescType = new RateCodeDescriptionType();
                    rateCodeDescType.Code = "LOO";
                    rateCodeDescType.Description = "LOOSE";
                    handUnitType.Type = rateCodeDescType;
                    freightRateRequest.HandlingUnitTwo = handUnitType;

                    /** **************HandlingUnitOne************************************* */

                    /*
                    RateCodeDescriptionType altRatesOption = new RateCodeDescriptionType();
                    altRatesOption.Code = "3";
                    freightRateRequest.AlternateRateOptions = altRatesOption;
                    */
                    freightRateRequest.TimeInTransitIndicator = "";

                    PickupRequestType pickupOption = new PickupRequestType();
                    pickupOption.PickupDate = pickupDate;
                    freightRateRequest.PickupRequest = pickupOption;

                    PickupOptionsType pickupOptions = new PickupOptionsType();

                    if (chkGFHolidayPickup.Checked) {
                        pickupOptions.HolidayPickupIndicator = "";
                    }
                    if(chkGFInsidePickup.Checked)
                    {
                        pickupOptions.InsidePickupIndicator = "";
                    }
                    if(chkGFResidentialPickup.Checked)
                    {
                        pickupOptions.ResidentialPickupIndicator = "";
                    }
                    if (chkGFWeekendPickup.Checked)
                    {
                        pickupOptions.WeekendPickupIndicator = "";
                    }
                    if (chkGFLiftgatePickup.Checked)
                    {
                        pickupOptions.LiftGateRequiredIndicator = "";
                    }
                    if (chkGFLimitedAccessPickup.Checked)
                    {
                        pickupOptions.LimitedAccessPickupIndicator = "";
                    }

                    DeliveryOptionsType deliveryOptions = new DeliveryOptionsType();

                    if (chkGFCallBeforeDelivery.Checked)
                    {
                        deliveryOptions.CallBeforeDeliveryIndicator = "";
                    }
                    if (chkGFHolidayDelivery.Checked)
                    {
                        deliveryOptions.HolidayDeliveryIndicator = "";
                    }
                    if (chkGFInsideDelivery.Checked)
                    {
                        deliveryOptions.InsideDeliveryIndicator = "";
                    }
                    if (chkGFResidentialDelivery.Checked)
                    {
                        deliveryOptions.ResidentialDeliveryIndicator = "";
                    }
                    if (chkGFWeekendDelivery.Checked)
                    {
                        deliveryOptions.WeekendDeliveryIndicator = "";
                    }
                    if (chkGFLiftgateDelivery.Checked)
                    {
                        deliveryOptions.LiftGateRequiredIndicator = "";
                    }
                    if (chkGFLimitedAccessDelivery.Checked)
                    {
                        deliveryOptions.LimitedAccessDeliveryIndicator = "";
                    }

                    FreightRateWebReference.ShipmentServiceOptionsType shipmentServiceOptions = new FreightRateWebReference.ShipmentServiceOptionsType();
                    shipmentServiceOptions.PickupOptions = pickupOptions;
                    shipmentServiceOptions.DeliveryOptions = deliveryOptions;
                    freightRateRequest.ShipmentServiceOptions = shipmentServiceOptions;

                    FreightRateWebReference.UPSSecurity upss = new FreightRateWebReference.UPSSecurity();
                    FreightRateWebReference.UPSSecurityServiceAccessToken upsSvcToken = new FreightRateWebReference.UPSSecurityServiceAccessToken();
                    upsSvcToken.AccessLicenseNumber = Config.UPSAccessKey;
                    upss.ServiceAccessToken = upsSvcToken;
                    FreightRateWebReference.UPSSecurityUsernameToken upsSecUsrnameToken = new FreightRateWebReference.UPSSecurityUsernameToken();
                    upsSecUsrnameToken.Username = Config.UPSUserName;
                    upsSecUsrnameToken.Password = Config.UPSPassword;
                    upss.UsernameToken = upsSecUsrnameToken;
                    ...
                    Response.Write("Request: " + requestXml + Environment.NewLine + Environment.NewLine);
                    Response.Write("Response: " + responseXml + Environment.NewLine + Environment.NewLine);

                    Response.Write("<hr/>");
                    
                    if (freightRateResponse.Response.Alert != null)
                    {
                        Response.Write("freightRateResponse.Response.Alert.Count: " + freightRateResponse.Response.Alert.Count().ToString() + "<br/>");
                        foreach(FreightRateWebReference.CodeDescriptionType alert in freightRateResponse.Response.Alert)
                        {
                            Response.Write(" -- alert: " + alert.Code + " (" + alert.Description + ")<br/>");
                        }
                    }

                    if (freightRateResponse.Response.AlertDetail != null)
                    {
                        Response.Write("freightRateResponse.Response.AlertDetail.Count: " + freightRateResponse.Response.AlertDetail.Count().ToString() + "<br/>");
                        foreach(DetailType alertDetail in freightRateResponse.Response.AlertDetail)
                        {
                            Response.Write(" -- alertdetail: " + alertDetail.Code + " (" + alertDetail.Description + ")<br/>");
                        }
                    }

                    if (freightRateResponse.Response.ResponseStatus != null)
                    {
                        Response.Write("freightRateResponse.Response.ResponseStatus: " + freightRateResponse.Response.ResponseStatus.Code + " (" + freightRateResponse.Response.ResponseStatus.Description + ")<br/>");
                    }

                    if (freightRateResponse.Response.TransactionReference != null)
                    {
                        Response.Write("freightRateResponse.Response.TransactionReference.CustomerContext: " + freightRateResponse.Response.TransactionReference.CustomerContext + "<br/>");
                        Response.Write("freightRateResponse.Response.TransactionReference.TransactionIdentifier: " + freightRateResponse.Response.TransactionReference.TransactionIdentifier + "<br/>");
                    }

                    if (freightRateResponse.AlternateRatesResponse != null)
                    {
                        Response.Write("freightRateResponse.AlternateRatesResponse.Count: " + freightRateResponse.AlternateRatesResponse.Count().ToString() + "<br/>");
                        foreach (AlternateRatesResponseType altRatesResponse in freightRateResponse.AlternateRatesResponse)
                        {
                            Response.Write(" -- altRatesResponse: " + altRatesResponse.AlternateRateType + " (add'l info available to display)<br/>");
                        }
                    }

                    Response.Write("freightRateResponse.BillableShipmentWeight: " + freightRateResponse.BillableShipmentWeight.Value + " " + freightRateResponse.BillableShipmentWeight.UnitOfMeasurement.Code + " (" + freightRateResponse.BillableShipmentWeight.UnitOfMeasurement.Description + ")<br/>");

                    if (freightRateResponse.Commodity != null)
                    {
                        Response.Write("freightRateResponse.Commodity.Count: " + freightRateResponse.Commodity.Count().ToString() + "<br/>");
                        foreach(CommodityWeightType comm in freightRateResponse.Commodity)
                        {
                            Response.Write(" -- Commodity -- <br/>");
                            Response.Write("     -- CommodityID: " + comm.CommodityID + "<br/>");
                            Response.Write("     -- Description: " + comm.Description + "<br/>");
                            if (comm.Weight != null)
                            {
                                Response.Write("     -- Weight: " + comm.Weight.Value + " " + comm.Weight.UnitOfMeasurement.Code + " (" + comm.AdjustedWeight.UnitOfMeasurement.Description + ")<br/>");
                            }
                            if (comm.AdjustedWeight != null)
                            {
                                Response.Write("     -- AdjustedWeight: " + comm.AdjustedWeight.Value + " " + comm.AdjustedWeight.UnitOfMeasurement.Code + " (" + comm.AdjustedWeight.UnitOfMeasurement.Description + ")<br/>");
                            }

                        }
                    }

                    if (freightRateResponse.GuaranteedIndicator != null)
                    {
                        Response.Write("freightRateResponse.GuaranteedIndicator: IS PRESENT!<br/>");
                    }

                    if (freightRateResponse.HandlingUnits != null)
                    {
                        Response.Write("freightRateResponse.HandlingUnits.Quantity: " + freightRateResponse.HandlingUnits.Quantity + "<br/>");
                        Response.Write("freightRateResponse.HandlingUnits.Type.Code: " + freightRateResponse.HandlingUnits.Type.Code + "<br/>");
                    }

                    if (freightRateResponse.MinimumBillableWeightAppliedIndicator != null)
                    {
                        Response.Write("freightRateResponse.MinimumBillableWeightAppliedIndicator: IS PRESENT!<br/>");
                    }

                    if (freightRateResponse.MinimumChargeAppliedIndicator != null)
                    {
                        Response.Write("freightRateResponse.MinimumChargeAppliedIndicator: IS PRESENT!<br/>");
                    }

                    if (freightRateResponse.NextAvailablePickupDate != null)
                    {
                        Response.Write("freightRateResponse.PickupDate: " + freightRateResponse.NextAvailablePickupDate + "<br/>");
                    }

                    if (freightRateResponse.Rate != null)
                    {
                        Response.Write("freightRateResponse.Rate.Count: " + freightRateResponse.Rate.Count().ToString() + "<br/>");
                        foreach(RateType rate in freightRateResponse.Rate)
                        {
                            Response.Write(" -- Rate -- <br/>");
                            if (rate.Type != null)
                            {
                                Response.Write("     -- Type: " + rate.Type.Code + " (" + rate.Type.Description + ")<br/>");
                            }
                            if (rate.Factor != null)
                            {
                                Response.Write("     -- Factor: " + rate.Factor.Value + " " + rate.Factor.UnitOfMeasurement.Code + " (" + rate.Factor.UnitOfMeasurement.Description + ")<br/>");
                            }
                            if (rate.SubTypeCode != null)
                            {
                                Response.Write("     -- SubTypeCode: " + rate.SubTypeCode + "<br/>");
                            }

                        }
                    }

                    if (freightRateResponse.RatingSchedule != null)
                    {
                        Response.Write("freightRateResponse.RatingSchedule: " + freightRateResponse.RatingSchedule.Code + " (" + freightRateResponse.RatingSchedule.Description + ")<br/>");
                    }

                    if (freightRateResponse.Service != null)
                    {
                        Response.Write("freightRateResponse.Service: " + freightRateResponse.Service.Code + " (" + freightRateResponse.Service.Description + ")<br/>");
                    }

                    if (freightRateResponse.TimeInTransit != null)
                    {
                        Response.Write("freightRateResponse.TimeInTransit.DaysInTransit: " + freightRateResponse.TimeInTransit.DaysInTransit + "<br/>");
                    }

                    if (freightRateResponse.TotalShipmentCharge != null)
                    {
                        Response.Write("freightRateResponse.TotalShipmentCharge: " + freightRateResponse.TotalShipmentCharge.MonetaryValue + " " + freightRateResponse.TotalShipmentCharge.CurrencyCode + "<br/>");
                    }
                    Response.Write("<hr/>");

                    Response.Write("Response code: " + freightRateResponse.Response.ResponseStatus.Code + Environment.NewLine + Environment.NewLine);
                    Response.Write("Response description: " + freightRateResponse.Response.ResponseStatus.Description + Environment.NewLine + Environment.NewLine);
                    Response.Write("Debug: " + freightRateResponse.RatingSchedule.Description + Environment.NewLine + Environment.NewLine);
                    Response.Write("Debug: " + freightRateResponse.TotalShipmentCharge.MonetaryValue + Environment.NewLine + Environment.NewLine);


                    int transitDays = 0;
                    if (freightRateResponse.TimeInTransit != null)
                    {
                        int.TryParse(freightRateResponse.TimeInTransit.DaysInTransit, out transitDays);
                    }

                    double cost = 0;
                    if (freightRateResponse.TotalShipmentCharge != null)
                    {
                        double.TryParse(freightRateResponse.TotalShipmentCharge.MonetaryValue, out cost);
                    }
                    ...
                    #region -- Determine the GF markup percentage --
                    ...
                    {
                        Response.Write("Unable to find GF markup charges for plant code: " + plantCode + "<br/>");
                        sbResults.Append("Unable to find GF markup charges for plant code: " + plantCode + "<br/>");
                    }
                    #endregion


                    Response.Write("Cost is " + cost.ToString() + "<br/>");
                    Response.Write("Markup percentage is " + markupPercentage.ToString() + "<br/>");
                    Response.Write("Number of Packages is " + numPackages.ToString() + "<br/>");
                    Response.Write("Per package charge is " + perPackageCharge.ToString() + "<br/>");
                    Response.Write("Per shipment charge is " + perShipmentCharge.ToString() + "<br/>");
                    ...
                    Response.Write("Calculated total charge is " + totalCharges.ToString() + "<br/>");

                    lblResults.Text += "Calculated total charge is " + totalCharges.ToString() + "\n\n";

                    tblGFServices.Rows.Add(plantCode, "UPS Ground Freight", totalCharges, transitDays, "");
                ...
                catch (System.Web.Services.Protocols.SoapException ex)
                {
                    ...
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("---------Freight Rate Web Service returns error----------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write("---------\"Hard\" is user error \"Transient\" is system error----------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write("SoapException Message= " + ex.Message + Environment.NewLine + Environment.NewLine);
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("SoapException Category:Code:Message= " + ex.Detail.LastChild.InnerText + Environment.NewLine + Environment.NewLine);
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("SoapException XML String for all= " + ex.Detail.LastChild.OuterXml + Environment.NewLine + Environment.NewLine);
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("SoapException StackTrace= " + ex.StackTrace + Environment.NewLine + Environment.NewLine);
                    Response.Write("-------------------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                }
                catch (System.ServiceModel.CommunicationException ex)
                {
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("--------------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write("CommunicationException= " + ex.Message + Environment.NewLine + Environment.NewLine);
                    Response.Write("CommunicationException-StackTrace= " + ex.StackTrace + Environment.NewLine + Environment.NewLine);
                    Response.Write("-------------------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                ...
                catch (Exception ex)
                {
                    Response.Write("" + Environment.NewLine + Environment.NewLine);
                    Response.Write("-------------------------" + Environment.NewLine + Environment.NewLine);
                    Response.Write(" General Exception= " + ex.Message + Environment.NewLine + Environment.NewLine);
                    Response.Write(" General Exception-StackTrace= " + ex.StackTrace + Environment.NewLine + Environment.NewLine);
                    Response.Write("-------------------------" + Environment.NewLine + Environment.NewLine);

                }
                finally
                {
                    Response.Write("in finally section" + Environment.NewLine + Environment.NewLine);
                }

                /*
                string postData = "<?xml version=\"1.0\"?>";
                postData += "<quote>";
                postData += "<requestedMode>GF</requestedMode>";
                postData += "<requestedPickupDate>" + pickupDate + "</requestedPickupDate>";
                postData += "<shipper>";
                postData += "<city>" + shipFromCity + "</city>";
                postData += "<region>" + shipFromState + "</region>";
                ...
                postData += "<lineItems>";
                postData += "<lineItem>";
                postData += "<freightClass>" + GFClass + "</freightClass>";
                postData += "<weight>" + shipWeight + "</weight>";
                postData += "<weightUnit>LB</weightUnit>";
                postData += "</lineItem>";
                postData += "</lineItems>";

                string accessorials = "";// GetGFAccessorials();
                if (accessorials.Length > 0)
                {
                    postData += "<accessorials>";
                    string[] accessorialArray = accessorials.Split(';');
                ...
                */
                ...
                foreach (var rate in xmlDoc.Descendants("rate"))
                {
                    ...
                    //if ((carrier != "GF BENCHMARK") || (Session["DefaultPlant"].ToString() == "POR"))
                    if (carrier != "GF BENCHMARK")
                    {
                        tblGFServices.Rows.Add(plantCode, carrier, totalCharges, transitDays, direct);
                    }
                    else if (Session["DefaultPlant"].ToString() == "POR")
                    {
                        tblGFServices.Rows.Add(plantCode, carrier, cost, transitDays, direct);
                    }
            ...
            pnlGFRates.Visible = (tblGFServices.Rows.Count > 0);
            DataView dvGFRates = tblGFServices.DefaultView;

            gvGFRates.DataSource = dvGFRates;
            gvGFRates.DataBind();
            ...
            try
            {
                ...
                gvGFRates.RenderControl(htwGridResults);
                ...
                cmdLog.Connection = connLog;
                cmdLog.CommandType = CommandType.StoredProcedure;
                cmdLog.CommandText = "LogResultsGF";
            ...
            {
                handleError("ShowGFRates", "Error in saving results to DB: " + e.Message);
                sbResults.Append("Error in saving results to DB: " + e.Message + "<br/>");
                lblResults.Text += sbResults.ToString();
                lblResults.Visible = true;
            }
        ...
        {
            handleError("ShowGFRates", e.ToString());
            lblResults.Text += e.ToString();
            lblResults.Visible = true;
        }
    }
    ...
    private void ShowRates(string shipToConsignee, string shipToStreet, string shipToCity, string shipToState, string shipToZip, string shipToCountry, string plantCode, bool addressCorrected)
    {
        ...
        */
        ...
        {
            ShowGFRates(shipToConsignee, shipToStreet, shipToCity, shipToState, shipToZip, shipToCountry, plantCode, addressCorrected, totalWeight, numPackages);
        }
        else
        {
        ...
        if (plantCode != "ALL")
        {
            ...
            try
            {
                ...
                if (rateResponse.Response.Alert != null)
                {
                    Response.Write("rateResponse.Response.Alert.Count: " + rateResponse.Response.Alert.Count().ToString() + "<br/>");
                    foreach (CodeDescriptionType1 alert in rateResponse.Response.Alert)
                    {
                        Response.Write(" -- alert: " + alert.Code + " (" + alert.Description + ")<br/>");
                    }
                }
                if (rateResponse.Response.ResponseStatus != null)
                {
                    Response.Write("rateResponse.Response.ResponseStatus: " + rateResponse.Response.ResponseStatus.Code + " (" + rateResponse.Response.ResponseStatus.Description + ")<br/>");
                }
    ...
    {
        pnlLTLGFOptions.Visible = (lstRateWithGF.SelectedValue == "Yes" || lstRateWithLTL.SelectedValue == "Yes");
    ...
    {
        pnlLTLGFOptions.Visible = (lstRateWithGF.SelectedValue == "Yes" || lstRateWithLTL.SelectedValue == "Yes");
        pnlGFOptions.Visible = (lstRateWithGF.SelectedValue == "Yes");
    }
}