...
public partial class ValidateAndRateChoosePlant : System.Web.UI.Page
{
    ...
    private void GetInitialPlant()
    {
        // Pull Username of current user
        string UserName = "UNKNOWN";// HttpContext.Current.User.Identity.Name.Replace(Config.NetworkDomain + "\\", "").ToLower();
