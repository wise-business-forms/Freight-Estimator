...
public partial class ValidateAndRateWithLTL_PriorToBrandmark : System.Web.UI.Page
{
                ...
                try
                {
                    ...
                    foreach (RatedShipmentType ratedShipment in ratedShipments)
                    {
                        ...
                        else if ((isAirCWT && (serviceCWTType == "AIR")) || (isGroundCWT && (serviceCWTType == "GROUND")))
                        {
							...
							if(isAirCWT) {
								// Since our negotiated Air CWT rates is 70% of the published rate, reverse that and divide neg. rate by .7 to get published rate
								totalCharges = negotiatedCharges / .7;
							}
							if(isGroundCWT) {
								totalCharges = negotiatedCharges * 1.47;
							}
                        }
                        else
                        {
