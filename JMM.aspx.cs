...
public partial class JMM : System.Web.UI.Page
{
    int ValidateRequestId = 0;
    ...
    private void ValidateAndRateAddress()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                cmdLog.CommandText = "LogRequest_XAV_Test";
                ...
                ValidateRequestId = Convert.ToInt32(pRequestId.Value);
        ...
        if (plantCode != "ALL")
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    pRequestId.Value = ValidateRequestId;
