<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CWT.aspx.cs" Inherits="CWT" %>
                	...
                	<tr>
                		<td>
			                <table cellpadding="5" cellspacing="0" border="0" class="internalTable" width="100%">
			                    ...
			                    <tr>
			                        <td colspan="2" class="shipto">
                                        <asp:Panel ID="pnlBadAddress" runat="server" Visible="false">
                                            <font color="red">
                                                This address is not recognized by UPS, and UPS failed to provide any suggestions.<br />
