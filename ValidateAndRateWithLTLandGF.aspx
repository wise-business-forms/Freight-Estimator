<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidateAndRateWithLTLandGF.aspx.cs" Inherits="ValidateAndRateWithLTLandGF" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div class="containerMain">
        ...
        <p style="text-align:center;color:red;font-size:20px;">This is a TEST PAGE for the UPS Ground Freight user interface - Please do not use any of these rates for production orders</p>
                	...
                	<tr>
                		<td>
			                <table cellpadding="5" cellspacing="0" border="0" class="internalTable" width="100%">
			                    ...
			                    <tr>
			                        <td class="label" valign="top">
                                        Include Ground Freight Rates?<br />
                                        <font style="font-weight:normal;font-style:italic">Note: Ground Freight requires City, State, and Zip</font><br />
                                    </td>
			                        <td>
			                            <asp:ListBox ID="lstRateWithGF" runat="server" Rows="1" class="input" border="0" CausesValidation="false" AutoPostBack="true" OnSelectedIndexChanged="lstRateWithGF_SelectedIndexChanged">
			                                <asp:ListItem Text="No" Value="No" Selected="True" />
			                                <asp:ListItem Text="Yes" Value="Yes" />
			                            </asp:ListBox>

                                        <asp:Panel ID="pnlLTLGFOptions" runat="server" Visible="false">
                                            <table>
                                                <tr>
                                                    <td>Freight Class</td>
                                                    <td>
                                                        <asp:ListBox ID="lstLTLClass" runat="server" Rows="1" class="input-short" width="78">
                                                ...
                                                <tr>
                                                    <td>Pickup Date</td>
                                                    <td>
                                                        <asp:TextBox ID="txtPickupDate" runat="server" class="input-short"  width="70"/>
                                        ...
                                        <asp:Panel ID="pnlLTLOptions" runat="server" Visible="false">
                                            <table>
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2"><i>-- Please check all applicable LTL surcharges: --</i></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:Panel ID="pnlGFOptions" runat="server" Visible="false">
                                            <table>
                                                <%-- 
                                                <tr>
                                                    <td>Freight Class</td>
                                                    <td>
                                                        <asp:ListBox ID="lstGFClass" runat="server" Rows="1" class="input-short" width="78">
                                                            <asp:ListItem Text="50" Value="50" />
                                                            <asp:ListItem Text="55" Value="55" Selected="True" />
                                                            <asp:ListItem Text="60" Value="60" />
                                                            <asp:ListItem Text="65" Value="65" />
                                                ...
                                                <tr>
                                                    <td>Pickup Date</td>
                                                    <td>
                                                        <asp:TextBox ID="txtGFPickupDate" runat="server" class="input-short" width="70" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtGFPickupDate" ValidationExpression="^\d{1,2}/\d{1,2}/\d{2,4}$" Display="Dynamic">< invalid value</asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                                --%>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtGFCommodityDesc" runat="server" class="input-short" MaxLength="200" width="70" Text="Printed Forms"/>
                                                    </td>
                                                </tr>
                                                
                                                <tr>
                                                    <td># of Handling Units</td>
                                                    <td>
                                                        <asp:ListBox ID="lstGFNumHandlingUnits" runat="server" Rows="1" class="input-short" width="78">
                                                ...
                                                <tr>
                                                    <td>Type of Handling Unit</td>
                                                    <td>
                                                        <asp:ListBox ID="lstGFHandlingUnit" runat="server" Rows="1" class="input-short" width="78">
                                                            <asp:ListItem Text="PALLET" Value="PLT"/>
                                                            <asp:ListItem Text="SKID" Value="SKD" />
                                                            <asp:ListItem Text="CARBOY" Value="CBY" />
                                                            <asp:ListItem Text="TOTES" Value="TOT" />
                                                        </asp:ListBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:ListBox ID="lstGFPackagingType" runat="server" Rows="1" class="input-short" width="78">
                                                            <asp:ListItem Text="Bag" Value="BAG"/>
                                                            <asp:ListItem Text="Bale" Value="BAL" />
                                                            <asp:ListItem Text="Barrel" Value="BAR" />
                                                            <asp:ListItem Text="Bundle" Value="BDL" />
                                                            <asp:ListItem Text="Bin" Value="BIN" />
                                                            <asp:ListItem Text="Box" Value="BOX" />
                                                            <asp:ListItem Text="Basket" Value="BSK" />
                                                            <asp:ListItem Text="Bunch" Value="BUN" />
                                                            <asp:ListItem Text="Cabinet" Value="CAB" />
                                                            <asp:ListItem Text="Can" Value="CAN" />
                                                            <asp:ListItem Text="Carrier" Value="CAR" />
                                                            <asp:ListItem Text="Case" Value="CAS" />
                                                            <asp:ListItem Text="Carboy" Value="CBY" />
                                                            <asp:ListItem Text="Container" Value="CON" />
                                                            <asp:ListItem Text="Crate" Value="CRT" />
                                                            <asp:ListItem Text="Cask" Value="CSK" />
                                                            <asp:ListItem Text="Carton" Value="CTN" Selected="True" />
                                                            <asp:ListItem Text="Cylinder" Value="CYL" />
                                                            <asp:ListItem Text="Drum" Value="DRM" />
                                                            <asp:ListItem Text="Loose" Value="LOO" />
                                                            <asp:ListItem Text="Other" Value="OTH" />
                                                            <asp:ListItem Text="Pail" Value="PAL" />
                                                            <asp:ListItem Text="Pieces" Value="PCS" />
                                                            <asp:ListItem Text="Package" Value="PKG" />
                                                            <asp:ListItem Text="Pipe Line" Value="PLN" />
                                                            <asp:ListItem Text="Pallet" Value="PLT" />
                                                            <asp:ListItem Text="Rack" Value="RCK" />
                                                            <asp:ListItem Text="Reel" Value="REL" />
                                                            <asp:ListItem Text="Roll" Value="ROL" />
                                                            <asp:ListItem Text="Skid" Value="SKD" />
                                                            <asp:ListItem Text="Spool" Value="SPL" />
                                                            <asp:ListItem Text="Tube" Value="TBE" />
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2"><i>-- Please check all applicable GF surcharges: --</i></td>
                                                </tr>
                                                <tr>
                                                    <td>Holiday Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFHolidayPickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Inside Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFInsidePickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Residential Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFResidentialPickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Weekend Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFWeekendPickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Liftgate Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFLiftgatePickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Limited Access Pickup</td>
                                                    <td><asp:CheckBox ID="chkGFLimitedAccessPickup" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Call Before Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFCallBeforeDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Holiday Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFHolidayDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Inside Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFInsideDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Residential Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFResidentialDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Weekend Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFWeekendDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Liftgate Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFLiftgateDelivery" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Limited Access Delivery</td>
                                                    <td><asp:CheckBox ID="chkGFLimitedAccessDelivery" runat="server" /></td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
			                        </td>
...
We are having some system issues today so you may have some interruptions when retrieving rates. If you need any rates please feel free to call our customer service team at 866-551-1635<br/>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Panel ID="pnlGFRates" runat="server" Visible="false">
                                <br /><br />
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        <td>
                                            <!-- GF RATES -->
                                            <asp:GridView ID="gvGFRates" runat="server"
                                                AutoGenerateColumns="false"
                                                GridLines="None"   
                                                CssClass="shipGrid"
                                                AlternatingRowStyle-CssClass="alt">
